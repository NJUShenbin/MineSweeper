...
public class MineBoardPanel extends JPanel implements Observer {
	 ...
	 */
	public MineBoardPanel(int rows,int columns,CoreListener coreListener){
	...
	public void update(Observable o, Object arg) { 
		...
		updateMessage = (UpdateMessage) arg;
		}else {
			TransformObject object = (TransformObject)arg;
			updateMessage = object.getMsg();
		}

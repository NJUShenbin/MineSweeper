...
public class MainFrame implements Observer {
	...
	private void componentsInstantiation() {
		...
		body = new MineBoardPanel(defaultHeight,defaultWidth,coreListener);
	...
	private void initComponents() {
		...
		body.setBounds(2, head.getHeight()+5, body.getColumns() * buttonSize + 2
	...
	private void restart(int mineBoardHeight,int mineBoardWidth,String type) {
		...
		body = new MineBoardPanel(mineBoardHeight,mineBoardWidth,coreListener);
		...
		body.setBounds(2, head.getHeight()+5, mineBoardWidth * buttonSize + 2
	...
	public void setTime(int timeNum){
